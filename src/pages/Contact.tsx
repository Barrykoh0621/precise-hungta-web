...
const Contact = () => {
  usePageSeo({
    title: "Contact Hung Ta Instrument | Request Testing Machine Quotation",
    description:
      "Contact Hung Ta Instrument Malaysia for tensile testing machine quotation, universal testing machine enquiries, calibration, software and support.",
  });
      ...
      <div className="container mx-auto px-4">
        <AnimatedSection>
          ...
          <p className="text-primary-foreground/70 max-w-xl text-lg">
            Request a quotation for tensile testing machines, universal testing machines, calibration, software or service support.
          </p>
        </AnimatedSection>
      </div>
    </section>
      ...
      <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-[0.8fr_1fr] gap-10">
            ...
            <div className="bg-card border border-border rounded-lg p-5 flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  109, Taman A.S.T., Jalan Sungai Ujong,<br />
        ...
        <AnimatedSection delay={0.12}>
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">
              Include material, capacity, test standard and machine type so Hung Ta can recommend the right equipment.
            </p>
